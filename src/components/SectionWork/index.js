  ...
  return (
    <S.Section>
      ...
      <S.SectionContent>
        ...
        <S.Text>
          Informe seu CEP de localização, os pet shops apareceram com base na
          sua geolocalização
        </S.Text>
      </S.SectionContent>
      <S.SectionContent>
        ...
        <S.Text>
          Selecione um dos Pet Shop disponível na lista que atenda na sua região
        </S.Text>
      </S.SectionContent>
      <S.SectionContent>
        ...
        <S.Text>
          Escolhas os produtos que você irá compra, depois adicone ao carrinho
          de compras
        </S.Text>
      </S.SectionContent>
      <S.SectionContent>
        ...
        <S.Text>
          Escolha a forma de pagamento de sua preferência. Realizando pagamento
          online ou na entrega
        </S.Text>
      </S.SectionContent>
    </S.Section>
  );
